...
fields(Args1)->
    ...
    {Descricao, Semana, Tolerancia, Setor_id, HoraInicialFormatada, HoraFinalFormatada}.
...
event(#submit{message = {add_horarios,Args}},Context)->
    ...
    {Descricao, Semana, Tolerancia, Setor_id, HoraInicialFormatada, HoraFinalFormatada}=form_ctrl_horario:fields(Args1),
